...
skraken-build --db $KRAKEN_DB_NAME --download-taxonomy
skraken-build --db $KRAKEN_DB_NAME --download-library bacteria
skraken-build --db $KRAKEN_DB_NAME --download-library viruses
skraken-build --db $KRAKEN_DB_NAME --build --threads $KRAKEN_THREAD_CT \
